...
$sql = "SELECT * FROM vijesti WHERE kategorija = 'deporte' ORDER BY datum DESC";
...
<head>
    <meta charset="UTF-8">
    <title>Deporte - EL DEBATE</title>
    <link rel="stylesheet" href="style.css">
</head>
<body>

<header class="header">
    <h1 class="logo">EL DEBATE - Deporte</h1>
    <nav>
        <ul>
            <li><a href="index.php">HOME</a></li>
            <li><a href="mundo.php">MUNDO</a></li>
            <li><a href="deporte.php" class="active">DEPORTE</a></li>
...
<main class="main">
    ...
    <?php else: ?>
        <p>Nema vijesti za kategoriju Deporte.</p>
    <?php endif; ?>
</main>
